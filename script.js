(function () {
    ...
    onvisible.add("h1.style1, h2.style1, h3.style1, p.style1", { style: "fade-down", speed: 1125, intensity: 2, delay: 0, replay: false });
    onvisible.add("h1.style3, h2.style3, h3.style3, p.style3", { style: "flip-backward", speed: 1250, intensity: 10, delay: 125, replay: false });
    onvisible.add(".buttons.style1", { style: "fade-up", speed: 1000, intensity: 5, delay: 0, stagger: 125, replay: false });
    onvisible.add(".image.style1", { style: "zoom-out", speed: 1500, intensity: 10, delay: 0, replay: false });
    onvisible.add("h1.style2, h2.style2, h3.style2, p.style2", { style: "fade-down", speed: 1250, intensity: 3, delay: 500, replay: false });
    onvisible.add("hr.style1", { style: "fade-left", speed: 1000, intensity: 3, delay: 0, replay: false });
    onvisible.add(".icons.style1", { style: "fade-left", speed: 1000, intensity: 2, delay: 0, stagger: 125, replay: false });
})();
(function () {
                var on = addEventListener,
                    $ = function (q) {
